...
namespace MUI
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        public void CreateDeviceResources(GraphicsDevice gd, OutputDescription outputDescription)
        {
            ...
            //byte[] vertexShaderBytes = Resources.Shaders.GLSL.imgui_vertex;
            //byte[] fragmentShaderBytes = Resources.Shaders.GLSL.imgui_frag;

            byte[] vertexShaderBytes = Resources.Shaders.Vulkan.imgui_vertex;
            byte[] fragmentShaderBytes = Resources.Shaders.Vulkan.imgui_frag;
            ...
            _vertexLayouts = new VertexLayoutDescription[]
            {
        ...
        public void PostInit()
        {
            ...
            GraphicsPipelineDescription pd = new GraphicsPipelineDescription(
                ...
                new ShaderSetDescription(_vertexLayouts, new[] { _vertexShader, _fragmentShader }),
                new ResourceLayout[] { _layout, _textureLayout },
                _outputDescription);
            _pipeline = _gd.ResourceFactory.CreateGraphicsPipeline(ref pd);

            _mainResourceSet = _gd.ResourceFactory.CreateResourceSet(new ResourceSetDescription(_layout,
                _projMatrixBuffer,
                _gd.PointSampler));
